...
public class ErrorCodeMessages {
    ...
    public static final String PERSON_NOT_FOUND_API_CODE = "401";
    public static final String PERSON_NOT_FOUND_ERROR = "PERSON_NOT_FOUND";
    public static final String PERSON_NOT_FOUND_MESSAGE = "No se encontró la persona";
    public static final String PERSON_NOT_FOUND_SOLUTION = "Verifique los datos";
